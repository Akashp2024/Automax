...
class RegisterView(View):
    def get(self,request):
        ...
        return render(request,'views/register.html',{'register_form': UserCreationForm()})
    ...
    def post(self,request):
        ...
        if register_form.is_valid():
            ...
            login(request,user)
            messages.success(request,f'{user.username} Registered Successfully. You are now logged in')
            return redirect('home')
        else:
