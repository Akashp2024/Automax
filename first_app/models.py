...
import uuid
from first_app.consts import CARS_BRANDS, TRANSMISSION_OPTIONS
from first_app.utils import user_listing_path
from user_app.models import Profile,Location
