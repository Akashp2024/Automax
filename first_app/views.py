...
from user_app.forms import LocationForm
...
def home(request):
    ...
    return render(request, 'views/home.html',{'listing_filter':listing_filter})
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if listing_form.is_valid() and location_form.is_valid():
                ...
                messages.error(request,'An error occured while trying to edit the listing.')
                return reload()
        else:
